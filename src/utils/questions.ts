 ...
 * @LastEditTime: 2021-07-28 00:10:31
 */

import * as inquirer from 'inquirer';
import utils from './utils';
import { CreateResult, FrontEndFrameType } from './declare';
 ...
 * @return {Promise<T>}
 */
export function handleCreateQuestionsList<T>(questions: inquirer.QuestionCollection): Promise<T> {
